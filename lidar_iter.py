...
class RPLidar(object):
    ...
    def __init__(self, port, baudrate=115200, timeout=1, logger=None):
        ...
        self.q = queue.Queue()
        self.thr = threading.Thread(target=self._iter_scans)
    ...
    def init_logger(self):
        '''
        Initiate a logger for lidar_iter
        '''
        logger = logging.getLogger('Main.lidar_iter')
    ...
    def _iter_scans(self, max_buf_meas=500, min_len=5):
